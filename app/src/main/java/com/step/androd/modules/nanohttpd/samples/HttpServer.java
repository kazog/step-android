...
public class HttpServer {
    private static final Logger logger = Logger.getLogger("DtalkHttpServer");
    ...
    public static final URL DEFAULT_HOME_PAGE = HttpServer.class.getResource(STATIC_PAGE_PREFIX + "/index.html");
//    private static final Map<String,String> MIME_OF_SUFFIX = new HashMap<String,String>();
//            .put(".jpeg", "image/jpeg")
//            .put(".jpg", "image/jpeg")
//            .put(".png", "image/png")
//            .put(".gif", "image/gif")
